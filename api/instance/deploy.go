...
func DeployInstance(c *fiber.Ctx, chall_id int, teamid int64) (*models.Flag, error) {
	...
	// pod := getPodObject(instance_name, flagObject)
	...
	flagObject.Deployment = challenge.Deployment
...
// func getPodObject(instance_name string, flagObject models.Flag) *core.Pod {
